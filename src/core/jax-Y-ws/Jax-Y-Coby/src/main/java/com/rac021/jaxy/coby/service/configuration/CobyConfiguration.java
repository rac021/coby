...
public class CobyConfiguration {
    ...
    private       String cobyPipeline             = null ;
	...
	try ( FileInputStream input = new FileInputStream(configFile) ) {
                ...
                prop.load(input) ;
		cobyPipeline = prop.getProperty("coby_script").replaceAll(" +", " ").trim() ;
		loggerFile   = prop.getProperty("logger_file").replaceAll(" +", " ").trim() ; 
		frequencyUpdateTimeMs = Integer.parseInt(prop.getProperty("frequency_update_time_ms")
                                                             .replaceAll(" +", " ").trim());
		...
		csvSep   = prop.getProperty("csv_sep").replaceAll(" +", " ").trim() ; 
                ...
                outputDataFolder   = prop.getProperty("coby_output_data_folder").replaceAll(" +", " ").trim() ; 
                ...
                System.out.println("     -->  coby_script               = " + cobyPipeline )                     ;
